...
FIRST_constructor_declarator = [IDENTIFIER]
...
FIRST_integral_type = [INT_LITERAL, CHAR_LITERAL]
FIRST_literal = [INT_LITERAL, CHAR_LITERAL, STRING_LITERAL, NULL] + FIRST_boolean_type
...
FIRST_rest_variable_declarators = [LAMBDA, COMMA]
FIRST_return_statement = [RETURN]
FIRST_variable_declarator = [IDENTIFIER]
...
FIRST_statement_without_trailing_substatements = FIRST_block + FIRST_empty_statement + FIRST_return_statement
...
FIRST_block_statement = FIRST_local_variable_declaration + FIRST_statement
...
FIRST_field_access = [SUPER, INT_LITERAL] + FIRST_boolean_type + [CHAR_LITERAL, STRING_LITERAL, NULL, THIS, PAREN_OPEN,NEW]
